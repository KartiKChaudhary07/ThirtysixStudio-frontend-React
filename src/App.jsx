...
function App() {
  ...
  <h1 className="text-8xl tracking-tighter text-center">about the brand</h1>
  <p className="text-4xl leading-[1.8] w-[80%] mx-auto mt-10 font-light text-center">
    we are a team of designers, developers, and strategists who are passionate
    about creating digital experiences that are both beautiful and functional,
    we are a team of designers, developers, and strategists who are passionate
    about creating digital experiences that are both beautiful and functional.
  </p>
